...
> Setup and configuration for webpack.
...
- open your browser and go to [the project's repository on github](https://github.com/carlylechia/WebPack-Boilerplate);
- Click on the `code button` and copy the https link that is provided on the dropdown;
- open terminal or commandline from the folder you created in the first step, and type in the command, "git clone " and then paste the url you copied on the previous step, (https://github.com/carlylechia/WebPack-Boilerplate.git).
...
Feel free to check the [issues page](https://github.com/carlylechia/WebPack-Boilerplate).
